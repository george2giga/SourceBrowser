...
{
    public class StashSolutionRetriever
    {
        private string _url;
        ...
        public StashSolutionRetriever(string url)
        {
        ...
        {
            string baseRepositoryPath = Path.Combine(System.Web.Hosting.HostingEnvironment.MapPath("~/"),"StashStaging");
